                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= base_url('user/edit_riwayat/') . $riwayat['no_pengajuan']; ?>" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="exampleFormControlInput1" value="<?= $riwayat['nama_sopir'] ?>" readonly>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <!-- <span><b><a class="btn btn-info rounded btn-sm" href="<?= base_url('assets/data/bukti/' . $riwayat['bukti']) ?>" target="blank"><i class="fas fa-download">Bukti Perjalanan </i></a></b></span> -->
                                                    </div>
