...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Jadwal Pengguna</h1>
    </div>
    <!-- Content Row -->
    <div class="row">
        <!-- Content Column -->
                            ...
                            <tbody>
                                <?php foreach ($riwayat as $riwayat) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><b><a href="" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#infoModal<?= $riwayat['no_pengajuan'] ?>"><i class="fas fa-edit"></i></a></b>
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= base_url('sopir/riwayat_upload/') . $riwayat['no_pengajuan']; ?>" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="exampleFormControlInput1" name="awal" value="<?= $riwayat['km_awal'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="surat">Masukkan Bukti Perjalanan</label>
                                                                <input type="file" class="form-control-file" id="surat" name="bukti">
                                                            </div>
                                        ...
                                        <div class="modal fade" id="cancelModal<?= $riwayat['no_pengajuan'] ?>" tabindex="-1" aria-labelledby="cancelModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= base_url('sopir/riwayat_cancel/') . $riwayat['no_pengajuan']; ?>" method="POST" enctype="multipart/form-data">
                                                            <p>Apakah anda yakin ingin menolak jadwal? Jika iya klik oke untuk melanjutkan</p>
