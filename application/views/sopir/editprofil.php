...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url('sopir/index') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-reply fa-sm text-white-50"></i> Kembali</a>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 mb-4">
            ...
            <form action="" method="POST">
                ...
                <img class="img-profile rounded-circle" src="<?= base_url('assets/img/') . $sopir['foto']; ?> " style="width: 200px; height: 200px; align: center;">
                <div class="form-row">
                    <div class="form-group col-md-8 ml-3 mt-3">
                        <label for="kode"><strong>Jenis Mobil</strong></label>
                        <input type="text" name="jenis_mobil" placeholder="Masukkan Sub Bagian / Komisi" autocomplete="off" class="form-control" id="subbag" value="<?= $sopir['jenis_mobil']; ?>" readonly>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-8 ml-3 mt-3">
                        <label for="kode"><strong>No Polisi</strong></label>
                        <input type="text" name="no_plat" placeholder="Masukkan Sub Bagian / Komisi" autocomplete="off" class="form-control" id="subbag" value="<?= $sopir['no_plat']; ?>" readonly>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-8 ml-3 mt-3">
