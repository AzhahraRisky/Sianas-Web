                ...
                <form action="<?= base_url('sopir/service_tambah') ?>" id="form_tambah" method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3">
                            ...
                            <input class="form-control" type="text" name="jenis_mobil" value="<?= $service['jenis_mobil'] ?>">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3">
                            <label for="email"><strong>No Polisi</strong></label>
                            <input class="form-control" type="text" name="no_plat" value="<?= $service['no_plat'] ?>">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3">
                            <label for="surat">Masukkan Bukti Service (pdf)</label>
