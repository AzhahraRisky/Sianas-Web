        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <form action="" method="POST">
                    <input type="hidden" name="no_sopir" value="<?= $sopir['no_sopir']; ?>">
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3 mt-3">
                            <label for="kode"><strong>Jenis Mobil</strong></label>
                            <input type="text" name="jenis_mobil" placeholder="Masukkan Jenis Mobil" autocomplete="off" class="form-control" id="subbag" value="-">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3 mt-3">
                            <label for="kode"><strong>No Polisi</strong></label>
                            <input type="text" name="no_plat" placeholder="Masukkan No Polisi" autocomplete="off" class="form-control" id="subbag" value="-">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3 mt-3">
