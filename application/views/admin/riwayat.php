                        ...
                        <table class="table table-hover table-bordered" width="100%" cellspacing="0">
                            <thead class="text-center">
                                <tr>
                                    ...
                                    <td>Konfirmasi Pengguna</td>
                                    <td>Konfirmasi Sopir</td>
                                    <td>Aksi</td>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($riwayat as $riwayat) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php if ($riwayat['konfirmasi_sopir'] == "Dikonfirmasi") {
                                                                    echo '<span class="badge badge-success">Dikonfirmasi</span>';
                                                                } else if ($riwayat['konfirmasi_sopir'] == "Diproses") {
                                                                    echo '<span class="badge badge-info">Diproses</span>';
                                                                } else {
                                                                    echo '<span class="badge badge-danger">Dicancel</span>';
                                                                } ?></td>
                                        <td class="text-center"><b><?php
                                                                    if ($riwayat['konfirmasi'] == "Dicancel") {
                                                                        echo '<button type="button" href="" class="btn btn-warning btn-sm" disabled><i class="fas fa-edit"></i></button>';
                                                                    } else {
                                                                        echo '<a href="" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#infoModal' . $riwayat['no_pengajuan'] . '"><i class="fas fa-edit"></i></a>';
                                                                    }
                                                                    ?></b>
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= base_url('riwayat/edit_riwayat/') . $riwayat['no_pengajuan']; ?>" method="POST" enctype="multipart/form-data">
                                                            <div class="form-group">
                                                                <label for="exampleFormControlInput1">Sopir</label>
                                                                <input type="text" class="form-control" id="exampleFormControlInput1" value="<?= $riwayat['nama'] ?>" readonly>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="exampleFormControlInput1" value="<?= $riwayat['km_awal'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="akhir">KM Akhir</label>
                                                                <input type="number" class="form-control" id="akhir" name="akhir" value="<?= $riwayat['km_akhir'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="akhir">Konfirmasi Sopir</label>
                                                                <input type="text" class="form-control" id="konfirmasi_sopir" name="konfirmasi_sopir" value="<?= $riwayat['konfirmasi_sopir'] ?>" readonly>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <span><b><a class="btn btn-info rounded btn-sm" href="<?= base_url('assets/data/surat/' . $riwayat['surat']) ?>" target="blank_"><i class="fas fa-download">Lihat Surat Peminjaman</i></a></b></span>
                                                            </div>
                                                            <?php
                                                            if ($riwayat['bukti'] != null) {
                                                                echo ' <span><b><a class="btn btn-info rounded btn-sm" href="' . base_url('assets/data/bukti/' . $riwayat['bukti']) . '" target="blank_"><i class="fas fa-download">Bukti Perjalanan</i></a></b></span>';
                                                            } else {
                                                                echo '<span class="badge badge-secondary">Bukti No Data !</span>';
                                                            }
                                                            ?>
