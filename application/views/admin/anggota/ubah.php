                ...
                <form action="" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3 mt-3">
                            ...
                            <input type="text" name="nip" placeholder="Masukkan NIP" autocomplete="off" class="form-control" id="nip" value="<?= $anggota['nip']; ?>">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3 mt-3">
                            <label for="kode"><strong>No Telpon</strong></label>
                            <input type="text" name="no_hp" placeholder="Masukkan No Telpon" autocomplete="off" class="form-control" id="no_hp" value="<?= $anggota['no_hp']; ?>">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3 mt-3">
                            <label for="kode"><strong>Jabatan</strong></label>
                            <input type="text" name="jabatan" placeholder="Masukkan Jabatan" autocomplete="off" class="form-control" id="jabatan" value="<?= $anggota['jabatan']; ?>">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3 mt-3">
