...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Input Anggota</h1>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <?php endif; ?>
                <form action="<?= base_url('anggota/tambah') ?>" id="form_tambah" method="POST">
                <input type="hidden" name="role" value="2">
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3 mt-3">
                            <label for="kode"><strong>Sub Bagian / Komisi</strong></label>
                            <input type="text" name="subbag" placeholder="Masukkan Sub Bagian" autocomplete="off" class="form-control">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3">
                            <label for="email"><strong>Nama</strong></label>
                            <input type="text" name="nama" placeholder="Masukkan Nama" autocomplete="off" class="form-control">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3">
                            <label for="email"><strong>NIP</strong></label>
                            <input type="text" name="nip" placeholder="Masukkan NIP" autocomplete="off" class="form-control">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3">
                            <label for="email"><strong>No Telpon</strong></label>
                            <input type="text" name="no_hp" placeholder="Masukkan Telpon" autocomplete="off" class="form-control">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3">
                            <label for="email"><strong>Jabatan</strong></label>
                            <input type="text" name="jabatan" placeholder="Masukkan Jabatan" autocomplete="off" class="form-control">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-8 ml-3">
